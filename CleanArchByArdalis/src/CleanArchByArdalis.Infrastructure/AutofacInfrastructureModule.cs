...
using Autofac;
using CleanArchByArdalis.Core.ContributorAggregate;
using CleanArchByArdalis.Core.Interfaces;
using CleanArchByArdalis.Infrastructure.Data;
using CleanArchByArdalis.Infrastructure.Data.Queries;
using CleanArchByArdalis.Infrastructure.Email;
using CleanArchByArdalis.UseCases.Contributors.Create;
using CleanArchByArdalis.UseCases.Contributors.List;
using MediatR;
using MediatR.Pipeline;
using Module = Autofac.Module;

namespace CleanArchByArdalis.Infrastructure;
